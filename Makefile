...
install-composer:
	...
	@if [ ! -f ./composer.phar ]; then curl -s http://getcomposer.org/installer | php -d date.timezone="Europe/Berlin" -- --install-dir=./; fi

install-dependencies:

	@make install-composer
	@php -d date.timezone="Europe/Berlin" ./composer.phar -- update
